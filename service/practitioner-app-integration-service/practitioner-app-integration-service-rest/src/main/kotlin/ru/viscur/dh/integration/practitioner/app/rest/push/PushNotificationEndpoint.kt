package ru.viscur.dh.integration.practitioner.app.rest.push
...
import ru.viscur.dh.integration.practitioner.app.api.event.PractitionerAppEvent
import ru.viscur.dh.integration.practitioner.app.rest.push.protocol.Protocol
...
class PushNotificationEndpoint(
    ...
    @EventListener(PractitionerAppEvent::class)
    fun onEvent(evt: PractitionerAppEvent) {
        try {
                            ...
                            while (idx != -1) {
                                ...
                                synchronized(session) {
                                    try {
                                        ...
                                        logger.trace("Error while sending message to practitioner app: {}", e.message)
                                    }
                                }
                                --idx
                            }
