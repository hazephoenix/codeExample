...
select resource_create('{"resourceType": "Concept", "id": "Practitioner_qualifications:Urologist", "code": "Urologist", "system": "ValueSet/Practitioner_qualifications", "display": "Врач-уролог", "relativeGender": "male"}'::jsonb);
