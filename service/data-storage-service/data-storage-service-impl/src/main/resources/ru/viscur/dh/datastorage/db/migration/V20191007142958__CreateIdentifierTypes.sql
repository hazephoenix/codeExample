...
select resource_create('{"resourceType": "Concept", "id": "Identifier_types:BRACELET", "code": "BRACELET", "system": "ValueSet/Identifier_types", "display": "Идентификатор браслета"}'::jsonb);
