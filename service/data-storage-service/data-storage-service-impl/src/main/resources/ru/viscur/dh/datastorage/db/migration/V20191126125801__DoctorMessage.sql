...
comment on column doctor_message.doctor_id is 'ID врача';
comment on column doctor_message.clinical_impression_id is 'ID обследования';
comment on column doctor_message.message_type is 'Тип сообщения';
comment on column doctor_message.hidden is 'Сообщение скрыто';
