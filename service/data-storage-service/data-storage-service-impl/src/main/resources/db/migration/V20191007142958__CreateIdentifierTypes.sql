...
select fhirbase_create('{"resourceType": "Concept", "id": "Identifier_types:CLAIM_NUMBER", "code": "CLAIM_NUMBER", "system": "ValueSet/Identifier_types", "display": "Номер обращения"}'::jsonb);
select fhirbase_create('{"resourceType": "Concept", "id": "Identifier_types:OFFICE_NUMBER", "code": "OFFICE_NUMBER", "system": "ValueSet/Identifier_types", "display": "Номер кабинета"}'::jsonb);