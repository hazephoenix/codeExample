delete from Questionnaire r where r.id = 'Sorting_criteria';

select fhirbase_create('{"resourceType": "Questionnaire", "id": "Sorting_criteria", "name": "Sorting criteria", "title": "Критерии сортировки", "status": "active", "item": [
    ...
    {"linkId": "Blood_pressure_lower_limit", "text": "Артериальное давление нижняя граница", "type": "choice", "answerOption": [
        {"valueCoding": {"code": "Less_than_90", "display": "Менее 90", "system": "ValueSet/Blood_pressure_lower_limit"}},
        {"valueCoding": {"code": "More_than_90", "display": "Более 90", "system": "ValueSet/Blood_pressure_lower_limit"}}
    ]},
    ...
    {"linkId": "Sorting_result", "text": "Результат сортировки", "type": "choice", "answerOption": [
