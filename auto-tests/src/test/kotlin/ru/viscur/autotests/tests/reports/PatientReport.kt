...
class PatientReport {
    ...
    fun patientQueueHistory() {
        ...
        QueRequests.officeIsBusy(referenceToLocation("Office:149"))
        ...
        QueRequests.officeIsReady(referenceToLocation("Office:149"))
        ...
        assertEquals(expectedQueueStatus, patientQueueHistory.find{it.officeId == office149}!!.status, "wrong status in queue history of patient: $patientId")
    }
}